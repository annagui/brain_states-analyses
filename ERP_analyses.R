...
phenInfo<-read.csv("pheno_dataset.csv", colClasses = 'character', header=T, stringsAsFactors = F)
#select phenotypic information: Outcome groups (TL = 0, EL-noASD = 1, EL-ASD = 3), age in days, sex (Male = 0, Female = 1), Mullen Early Learning Composite at 8 months, VABS Socialization Score at 3 years, VABS Motor Skills Score at 3 years)
